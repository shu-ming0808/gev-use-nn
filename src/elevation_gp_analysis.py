...
def resolve_analysis_paths(current_directory: str | Path) -> dict[str, Path]:
    """Return canonical repository paths regardless of the working directory."""
    ...
    return {
        ...
        "gev_path": PROCESSED_DATA_DIR / "grid_station_gev_params_with_loc.csv",
        "elevation_path": (
            SPATIAL_PREDICTOR_RAW_DIR
            / "taiwan_grid_elevation_001deg.csv"
        ),
